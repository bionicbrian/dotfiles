...
let g:colors_name = "Tomorrow-Plain"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  highlight LineNr term=NONE cterm=NONE ctermfg=DarkGrey ctermbg=NONE gui=NONE guifg=DarkGrey guibg=NONE
    ...
    " JavaScript
    call <SID>X("javascriptConst", s:foreground, "", "")
    call <SID>X("javaScriptReserved", s:foreground, "", "")
    call <SID>X("javaScriptStatement", s:foreground, "", "")
    call <SID>X("javaScriptLabel", s:foreground, "", "")
